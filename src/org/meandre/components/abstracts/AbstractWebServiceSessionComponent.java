		...
		try{
			...
			if( request instanceof EmptyHttpServletRequest ){
				...
				if(isOutputToConsoleVerbose())
					getConsoleOut().println(this.getClass().getName() +": Recieved Empty Reqeust");
			...
			//
			if(isOutputToConsoleVerbose())
				getConsoleOut().println(this.getClass().getName() +": Data event completed conditionally PushDataOutputs");
			
			if(pushDataOut){
				if(isOutputToConsoleVerbose())
					getConsoleOut().println(this.getClass().getName() +": Data event completed, ALL Push DataOutputs");
				...
				if(isOutputToConsoleVerbose())
					getConsoleOut().println(this.getClass().getName() +": Data event completed, NO Push DataOutputs");
			}
		}catch(Exception e){
